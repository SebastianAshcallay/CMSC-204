	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			if (e.getSource() == conversionBtn) {
				...
				catch (InvalidNotationFormatException | StackUnderflowException | StackOverflowException
						| QueueOverflowException exception)
				{
					// JOptionPane.showMessageDialog(null, exception.getMessage());
					Alert warning = new Alert(AlertType.WARNING);
					warning.setHeaderText(exception.getClass().getName());
					warning.setContentText(exception.getMessage());
					warning.show();
				}
				...
				catch (InvalidNotationFormatException | StackUnderflowException | StackOverflowException | NumberFormatException exception)
				{
					// JOptionPane.showMessageDialog(null, exception.getMessage());
					Alert warning = new Alert(AlertType.WARNING);
					warning.setHeaderText(exception.getClass().getName());
